...
namespace Sunshine.Service
{
    ...
    public class SunshineService : IntentService
    {
        ...
        public const string LocationQueryExtra = "lqe";
        ...
        protected async override void OnHandleIntent(Android.Content.Intent intent)
        {
            try
            {
                ...
                var locationQuery = intent.GetStringExtra(LocationQueryExtra);
        ...
        void GetWeatherDataFromJson(string forecastJsonStr, string locationSetting)
        {
            try
            {
                ...
                {
                    inserted = ContentResolver.BulkInsert(WeatherContract.Weather.ContentUri, contentValuesList.ToArray());
                }
        ...
        public long AddLocation(string locationSetting, string cityName, double lat, double lon)
        {
            ...
            var locationCursor = ContentResolver.Query(WeatherContract.Location.ContentUri, 
            ...
            else
            {
                ...
                var insertedUri = ContentResolver.Insert(WeatherContract.Location.ContentUri, contentValues);
